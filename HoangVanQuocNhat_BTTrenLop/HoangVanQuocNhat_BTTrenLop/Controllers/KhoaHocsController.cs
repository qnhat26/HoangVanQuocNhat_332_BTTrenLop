    ...
    public class KhoaHocsController : Controller
    {
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var khoaHoc = await _context.KhoaHocs
                .FirstOrDefaultAsync(m => m.mkh == id);
            if (khoaHoc == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("maKh,tenKH")] KhoaHoc khoaHoc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("maKh,tenKH")] KhoaHoc khoaHoc)
        {
            if (id != khoaHoc.mkh)
            {
                return NotFound();
        ...
        {
            return _context.KhoaHocs.Any(e => e.mkh == id);
        }
    }
}
